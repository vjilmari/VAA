...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{VAA_LR_items<-}\KeywordTok{c}\NormalTok{(}\StringTok{"y22"}\NormalTok{,}\StringTok{"y23"}\NormalTok{,}\StringTok{"y26"}\NormalTok{,}\StringTok{"y27"}\NormalTok{,}\StringTok{"y9"}\NormalTok{,}\StringTok{"y19"}\NormalTok{)}
\NormalTok{VAA_LR_items }\OperatorTok{%in%}\StringTok{ }\KeywordTok{names}\NormalTok{(df2011)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{VAA_GT_items<-}\KeywordTok{c}\NormalTok{(}\StringTok{"y4"}\NormalTok{,}\StringTok{"y5"}\NormalTok{,}\StringTok{"y1"}\NormalTok{,}\StringTok{"y21"}\NormalTok{)}
\NormalTok{VAA_GT_items }\OperatorTok{%in%}\StringTok{ }\KeywordTok{names}\NormalTok{(df2011)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{CS_LR_items<-}\KeywordTok{c}\NormalTok{(}\StringTok{"C1_2"}\NormalTok{,}\StringTok{"C1_7"}\NormalTok{,}\StringTok{"C1_8"}\NormalTok{)}
\NormalTok{CS_LR_items }\OperatorTok{%in%}\StringTok{ }\KeywordTok{names}\NormalTok{(df2011)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{CS_GT_items<-}\KeywordTok{c}\NormalTok{(}\StringTok{"C1_1"}\NormalTok{,}\StringTok{"C1_3"}\NormalTok{,}\StringTok{"C1_4"}\NormalTok{,}\StringTok{"C1_5"}\NormalTok{,}\StringTok{"C1_6"}\NormalTok{,}\StringTok{"C1_10"}\NormalTok{,}\StringTok{"C1_11"}\NormalTok{)}
\NormalTok{CS_GT_items }\OperatorTok{%in%}\StringTok{ }\KeywordTok{names}\NormalTok{(df2011)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Party_item }\OperatorTok{%in%}\StringTok{ }\KeywordTok{names}\NormalTok{(df2011)}
\end{Highlighting}
\end{Shaded}
...
Recode middle-responses (3) from yle items to NA, and 99 responses from
CS to NA
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df2011}\OperatorTok{$}\NormalTok{completely_missing<-}
\StringTok{  }\KeywordTok{rowSums}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(df2011[,obs_items[}\DecValTok{2}\OperatorTok{:}\KeywordTok{length}\NormalTok{(obs_items)]]))}\OperatorTok{==}\KeywordTok{length}\NormalTok{(obs_items)}\OperatorTok{-}\DecValTok{1}

\KeywordTok{table}\NormalTok{(df2011}\OperatorTok{$}\NormalTok{completely_missing)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat2011<-df2011 }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{reverse_items<-}\KeywordTok{c}\NormalTok{(}\StringTok{"y26"}\NormalTok{,}\StringTok{"y19"}\NormalTok{,}
                 \StringTok{"y4"}\NormalTok{,}\StringTok{"y1"}\NormalTok{,}\StringTok{"y21"}\NormalTok{,}
                 \StringTok{"C1_7"}\NormalTok{,}\StringTok{"C1_8"}\NormalTok{,}
                 \StringTok{"C1_3"}\NormalTok{,}\StringTok{"C1_5"}\NormalTok{,}\StringTok{"C1_10"}\NormalTok{,}\StringTok{"C1_11"}\NormalTok{)}

\NormalTok{reverse_items }\OperatorTok{%in%}\StringTok{ }\KeywordTok{names}\NormalTok{(df2011)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mis_H1H2<-mis_H1H2[mis_H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"=~"} \OperatorTok{|}\StringTok{ }\NormalTok{mis_H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"~~"}\NormalTok{,]}
\CommentTok{#see summary of the decisions}
\KeywordTok{table}\NormalTok{(mis_H1H2}\OperatorTok{$}\NormalTok{decision.pow)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#there are 9 misspecifications}
...
\NormalTok{mis_H1H2[,rounded.vars]<-}\KeywordTok{sapply}\NormalTok{(mis_H1H2[,rounded.vars],num.round)}
...
\NormalTok{mis_H1H2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(mis_H1H2}\OperatorTok{$}\NormalTok{decision.pow}\OperatorTok{==}\StringTok{"M"} \OperatorTok{|}\StringTok{ }
\StringTok{                }\NormalTok{mis_H1H2}\OperatorTok{$}\NormalTok{decision.pow}\OperatorTok{==}\StringTok{"EPC:M"}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mis.H1H2<-mis.H1H2[mis.H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"=~"} \OperatorTok{|}\StringTok{ }
\StringTok{                     }\NormalTok{(mis.H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"~~"} \OperatorTok{&}
\StringTok{                        }\NormalTok{mis.H1H2}\OperatorTok{$}\NormalTok{lhs}\OperatorTok{!=}\NormalTok{mis.H1H2}\OperatorTok{$}\NormalTok{rhs),]}
\CommentTok{#see summary of the decisions}
\KeywordTok{table}\NormalTok{(mis.H1H2}\OperatorTok{$}\NormalTok{decision.pow)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#there are several misspecifications}
...
\NormalTok{mis.H1H2[,rounded.vars]<-}\KeywordTok{sapply}\NormalTok{(mis.H1H2[,rounded.vars],num.round)}
...
\NormalTok{mis.H1H2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(mis.H1H2}\OperatorTok{$}\NormalTok{decision.pow}\OperatorTok{==}\StringTok{"M"} \OperatorTok{|}\StringTok{ }
\StringTok{                }\NormalTok{mis.H1H2}\OperatorTok{$}\NormalTok{decision.pow}\OperatorTok{==}\StringTok{"EPC:M"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}\KeywordTok{all_of}\NormalTok{(printed.vars)) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mis.H1H2<-}\KeywordTok{miPowerFit}\NormalTok{(fit_H1H2.exp.re}\FloatTok{.3}\NormalTok{,}\DataTypeTok{stdLoad=}\NormalTok{.}\DecValTok{40}\NormalTok{,}\DataTypeTok{cor=}\NormalTok{.}\DecValTok{20}\NormalTok{)}
\NormalTok{mis.H1H2<-mis.H1H2[mis.H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"=~"} \OperatorTok{|}\StringTok{ }
\StringTok{                     }\NormalTok{(mis.H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"~~"} \OperatorTok{&}
\StringTok{                        }\NormalTok{mis.H1H2}\OperatorTok{$}\NormalTok{lhs}\OperatorTok{!=}\NormalTok{mis.H1H2}\OperatorTok{$}\NormalTok{rhs),]}
\CommentTok{#see summary of the decisions}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{std.est.H1H2.exp.re}\FloatTok{.4}\NormalTok{<-}\KeywordTok{standardizedsolution}\NormalTok{(fit_H1H2.exp.re}\FloatTok{.4}\NormalTok{)}

\NormalTok{std.est.H1H2.exp.re}\FloatTok{.4}\NormalTok{[std.est.H1H2.exp.re}\FloatTok{.4}\OperatorTok{$}\NormalTok{op }\OperatorTok{==}\StringTok{ "=~"} \OperatorTok{|}
\StringTok{                        }\NormalTok{(std.est.H1H2.exp.re}\FloatTok{.4}\OperatorTok{$}\NormalTok{op }\OperatorTok{==}\StringTok{ "~~"} \OperatorTok{&}
\StringTok{                           }\NormalTok{std.est.H1H2.exp.re}\FloatTok{.4}\OperatorTok{$}\NormalTok{lhs }\OperatorTok{!=}\StringTok{ }\NormalTok{std.est.H1H2.exp.re}\FloatTok{.4}\OperatorTok{$}\NormalTok{rhs),]}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Analysis_2011_files/figure-latex/unnamed-chunk-34-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{std.est_H1H2.sub.re<-}\KeywordTok{standardizedsolution}\NormalTok{(fit_H1H2.sub.re)}
\NormalTok{std.est_H1H2.sub.re[std.est_H1H2.sub.re}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{":="} \OperatorTok{|}\StringTok{ }
\StringTok{               }\NormalTok{std.est_H1H2.sub.re}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"~~"} \OperatorTok{&}\StringTok{ }
\StringTok{               }\NormalTok{std.est_H1H2.sub.re}\OperatorTok{$}\NormalTok{lhs}\OperatorTok{!=}\NormalTok{std.est_H1H2.sub.re}\OperatorTok{$}\NormalTok{rhs,]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mis.H1H2<-}\KeywordTok{miPowerFit}\NormalTok{(fit_H1H2.sub.re,}\DataTypeTok{stdLoad=}\NormalTok{.}\DecValTok{40}\NormalTok{,}\DataTypeTok{cor=}\NormalTok{.}\DecValTok{20}\NormalTok{)}
\NormalTok{mis.H1H2<-mis.H1H2[mis.H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"=~"} \OperatorTok{|}\StringTok{ }
\StringTok{                     }\NormalTok{(mis.H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"~~"} \OperatorTok{&}
\StringTok{                        }\NormalTok{mis.H1H2}\OperatorTok{$}\NormalTok{lhs}\OperatorTok{!=}\NormalTok{mis.H1H2}\OperatorTok{$}\NormalTok{rhs),]}
\CommentTok{#see summary of the decisions}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#there are eight misspecifications}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{std.est_H1H2.sub.exp.re<-}\KeywordTok{standardizedsolution}\NormalTok{(fit_H1H2.sub.exp.re)}
\NormalTok{std.est_H1H2.sub.exp.re[std.est_H1H2.sub.exp.re}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{":="} \OperatorTok{|}\StringTok{ }
\StringTok{               }\NormalTok{std.est_H1H2.sub.exp.re}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"~~"} \OperatorTok{&}\StringTok{ }
\StringTok{               }\NormalTok{std.est_H1H2.sub.exp.re}\OperatorTok{$}\NormalTok{lhs}\OperatorTok{!=}\NormalTok{std.est_H1H2.sub.exp.re}\OperatorTok{$}\NormalTok{rhs,]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mis.H1H2<-}\KeywordTok{miPowerFit}\NormalTok{(fit_H1H2.sub.exp.re,}\DataTypeTok{stdLoad=}\NormalTok{.}\DecValTok{40}\NormalTok{,}\DataTypeTok{cor=}\NormalTok{.}\DecValTok{20}\NormalTok{)}
\NormalTok{mis.H1H2<-mis.H1H2[mis.H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"=~"} \OperatorTok{|}\StringTok{ }
\StringTok{                     }\NormalTok{(mis.H1H2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"~~"} \OperatorTok{&}
\StringTok{                        }\NormalTok{mis.H1H2}\OperatorTok{$}\NormalTok{lhs}\OperatorTok{!=}\NormalTok{mis.H1H2}\OperatorTok{$}\NormalTok{rhs),]}
\CommentTok{#see summary of the decisions}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{std.est_H1H2.sub.exp.re}\FloatTok{.2}\NormalTok{<-}\KeywordTok{standardizedsolution}\NormalTok{(fit_H1H2.sub.exp.re}\FloatTok{.2}\NormalTok{)}
\NormalTok{std.est_H1H2.sub.exp.re}\FloatTok{.2}\NormalTok{[std.est_H1H2.sub.exp.re}\FloatTok{.2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{":="} \OperatorTok{|}\StringTok{ }
\StringTok{               }\NormalTok{std.est_H1H2.sub.exp.re}\FloatTok{.2}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"~~"} \OperatorTok{&}\StringTok{ }
\StringTok{               }\NormalTok{std.est_H1H2.sub.exp.re}\FloatTok{.2}\OperatorTok{$}\NormalTok{lhs}\OperatorTok{!=}\NormalTok{std.est_H1H2.sub.exp.re}\FloatTok{.2}\OperatorTok{$}\NormalTok{rhs,]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat2011.party<-dat2011 }\OperatorTok{%>%}
...
\KeywordTok{table}\NormalTok{(dat2011.party}\OperatorTok{$}\NormalTok{puolue)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{num.dat}\FloatTok{.2011}\NormalTok{<-}\KeywordTok{data.frame}\NormalTok{(fit_H1H2}\OperatorTok{@}\NormalTok{Data}\OperatorTok{@}\NormalTok{X,dat2011}\OperatorTok{$}\NormalTok{puolue)}
\KeywordTok{names}\NormalTok{(num.dat}\FloatTok{.2011}\NormalTok{)<-}\KeywordTok{c}\NormalTok{(fit_H1H2}\OperatorTok{@}\NormalTok{Data}\OperatorTok{@}\NormalTok{ov}\OperatorTok{$}\NormalTok{name,}\StringTok{"puolue"}\NormalTok{)}
\NormalTok{num.dat}\FloatTok{.2011}\NormalTok{<-num.dat}\FloatTok{.2011} \OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(puolue}\OperatorTok{==}\StringTok{"KD"} \OperatorTok{|}
\StringTok{           }\NormalTok{puolue}\OperatorTok{==}\StringTok{"KESK"} \OperatorTok{|}
\StringTok{           }\NormalTok{puolue}\OperatorTok{==}\StringTok{"KOK"} \OperatorTok{|}
\StringTok{           }\NormalTok{puolue}\OperatorTok{==}\StringTok{"PS"} \OperatorTok{|}
...
\NormalTok{ICC<-}\KeywordTok{data.frame}\NormalTok{(multilevel}\OperatorTok{::}\KeywordTok{mult.icc}\NormalTok{(}\DataTypeTok{x=}\NormalTok{num.dat}\FloatTok{.2011}\NormalTok{[,obs_items[}\DecValTok{2}\OperatorTok{:}\KeywordTok{length}\NormalTok{(obs_items)]],}
                                     \DataTypeTok{grpid=}\NormalTok{num.dat}\FloatTok{.2011}\OperatorTok{$}\NormalTok{puolue))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ICC}\OperatorTok{$}\NormalTok{label<-}\KeywordTok{get_label}\NormalTok{(df2011[,}\KeywordTok{as.character}\NormalTok{(ICC[,}\DecValTok{1}\NormalTok{])])}

\CommentTok{#export to .csv file}
\KeywordTok{write.csv2}\NormalTok{(ICC,}\StringTok{"ICC_2011.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ind.items<-obs_items[}\DecValTok{2}\OperatorTok{:}\KeywordTok{length}\NormalTok{(obs_items)]}

\NormalTok{dat2011.gmc<-}\KeywordTok{data.frame}\NormalTok{(dat2011.party)}

\NormalTok{na.mean<-}\ControlFlowTok{function}\NormalTok{(var)\{}
  \KeywordTok{mean}\NormalTok{(var,}\DataTypeTok{na.rm=}\NormalTok{T)}
\NormalTok{\}}

\NormalTok{group.means<-dat2011.gmc }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(puolue) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarise_at}\NormalTok{(ind.items,na.mean)}

\NormalTok{dat2011.gmc<-}\KeywordTok{left_join}\NormalTok{(}\DataTypeTok{x=}\NormalTok{dat2011.gmc,}
...
\NormalTok{ind.items }\OperatorTok{%in%}\StringTok{ }\KeywordTok{names}\NormalTok{(dat2011.gmc)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{paste0}\NormalTok{(ind.items,}\StringTok{".pm"}\NormalTok{) }\OperatorTok{%in%}\StringTok{ }\KeywordTok{names}\NormalTok{(dat2011.gmc)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mis.H3H4<-}\KeywordTok{miPowerFit}\NormalTok{(fit_H3H4.re,}\DataTypeTok{stdLoad=}\NormalTok{.}\DecValTok{40}\NormalTok{,}\DataTypeTok{cor=}\NormalTok{.}\DecValTok{20}\NormalTok{)}
\NormalTok{mis.H3H4<-mis.H3H4[mis.H3H4}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"=~"} \OperatorTok{|}\StringTok{  }\NormalTok{mis.H3H4}\OperatorTok{$}\NormalTok{op}\OperatorTok{==}\StringTok{"~~"}\NormalTok{,]}
\CommentTok{#see summary of the decisions}
\KeywordTok{table}\NormalTok{(mis.H3H4}\OperatorTok{$}\NormalTok{decision.pow)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#there are 6 misspecifications}
...
\NormalTok{mis.H3H4[,rounded.vars]<-}\KeywordTok{sapply}\NormalTok{(mis.H3H4[,rounded.vars],num.round)}
...
\NormalTok{mis.H3H4 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(mis.H3H4}\OperatorTok{$}\NormalTok{decision.pow}\OperatorTok{==}\StringTok{"M"} \OperatorTok{|}\StringTok{ }
\StringTok{                }\NormalTok{mis.H3H4}\OperatorTok{$}\NormalTok{decision.pow}\OperatorTok{==}\StringTok{"EPC:M"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}\KeywordTok{all_of}\NormalTok{(printed.vars)) }
\end{Highlighting}
\end{Shaded}
